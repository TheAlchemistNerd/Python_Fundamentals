...
class Game(tk.Frame):
    ...
    def __init__(self, parent):
        ...
        super(Game, self).__init__(parent)    # parent will be root window
        self.parent = parent
    ...
    def win_reveal(self):
        ...
        self_choice = self.door_choice.get()
        ...
        # close doors 2 seconds aftr opening
        self.img_file = 'all_closed.png'
        self.parent.after(2000, self.update_image)

    def show_final(self):
        """Reveal the image behind user's final door choice & count wins."""
        door_list = list(self.doors)
